...
USDSBSAR_API std::shared_ptr<SubstanceAir::PackageDesc>
...
class USDSBSAR_API GraphInstanceData
{
public:
...
USDSBSAR_API std::shared_ptr<GraphInstanceData>
...
USDSBSAR_API const SubstanceAir::GraphDesc*
